...
library(ggplot2)
#GDD_SOS <- read.csv(file="\\\\141.20.140.91/SAN_Projects/Spring/workspace/Katja/germany/results/20190205_GDD_SOS.csv")
...
tab_3 <- as.data.frame(t(data.frame(
  ...
  "r_GO" = apply(GDD_SOS[c("LOG_NDVI", "LOG_EVI", "GAM_NDVI", "GAM_EVI", "PEP_SOS", "TT", "SQ")], 2, 
                   function(x) cor(x, GDD_SOS$PEP_SOS,use="complete.obs")),
  ...
  "r2_forcing" = c("LOG_NDVI" = summary(lm(LOG_NDVI~GDD_LOG_NDVI, GDD_SOS))$r.squared,
                   "LOG_EVI" = summary(lm(LOG_EVI~GDD_LOG_EVI, GDD_SOS))$r.squared,
                   "GAM_NDVI" = summary(lm(GAM_NDVI~GDD_GAM_NDVI, GDD_SOS))$r.squared,
                   "GAM_EVI" = summary(lm(GAM_EVI~GDD_GAM_EVI, GDD_SOS))$r.squared,
                   "PEP" = summary(lm(PEP_SOS~GDD_PEP, GDD_SOS))$r.squared,
                   "TT" = summary(lm(TT~GDD_mean, GDD_SOS))$r.squared,
                   "SQ" = summary(lm(SQ~GDD_mean, GDD_SOS))$r.squared
                   ),
  "r_forcing" = c("LOG_NDVI_TT" = cor(GDD_SOS$GDD_LOG_NDVI, GDD_SOS$LOG_NDVI, use="complete.obs"),
                  "LOG_EVI" = cor(GDD_SOS$GDD_LOG_EVI, GDD_SOS$LOG_EVI, use="complete.obs"),
                  "GAM_NDVI" = cor(GDD_SOS$GDD_GAM_NDVI, GDD_SOS$GAM_NDVI, use="complete.obs"),
                  "GAM_EVI" = cor(GDD_SOS$GDD_GAM_EVI, GDD_SOS$GAM_EVI, use="complete.obs"),
                  "PEP" = cor(GDD_SOS$GDD_PEP, GDD_SOS$PEP_SOS, use="complete.obs"),
                  "TT" = cor(GDD_SOS$GDD_mean, GDD_SOS$TT, use="complete.obs"),
                  "SQ" = cor(GDD_SOS$GDD_mean, GDD_SOS$SQ, use="complete.obs")
                  ),
  "r2_chilling" = c("LOG_NDVI" = summary(lm(LOG_NDVI~CD_LOG_NDVI, GDD_SOS))$r.squared,
                    "LOG_EVI" = summary(lm(LOG_EVI~CD_LOG_EVI, GDD_SOS))$r.squared,
                    "GAM_NDVI" = summary(lm(GAM_NDVI~CD_GAM_NDVI, GDD_SOS))$r.squared,
                    "GAM_EVI" = summary(lm(GAM_EVI~CD_GAM_EVI, GDD_SOS))$r.squared,
                    "PEP" = summary(lm(PEP_SOS~CD_PEP, GDD_SOS))$r.squared,
                    "TT" = summary(lm(TT~CD_mean, GDD_SOS))$r.squared,
                    "SQ" = summary(lm(SQ~CD_mean, GDD_SOS))$r.squared),
  "r_chilling" = c("LOG_NDVI" = cor(GDD_SOS$CD_LOG_NDVI, GDD_SOS$LOG_NDVI, use="complete.obs"),
                   "LOG_EVI" = cor(GDD_SOS$CD_LOG_EVI, GDD_SOS$LOG_EVI, use="complete.obs"),
                   "GAM_NDVI" = cor(GDD_SOS$CD_GAM_NDVI, GDD_SOS$GAM_NDVI, use="complete.obs"),
                   "GAM_EVI" = cor(GDD_SOS$CD_GAM_EVI, GDD_SOS$GAM_EVI, use="complete.obs"),
                   "PEP" = cor(GDD_SOS$CD_PEP, GDD_SOS$PEP_SOS, use="complete.obs"),
                   "TT" = cor(GDD_SOS$CD_mean, GDD_SOS$TT, use="complete.obs"),
                   "SQ" = cor(GDD_SOS$CD_mean, GDD_SOS$SQ, use="complete.obs")
                   ),
  "r2_elevation" = apply(GDD_SOS[c("LOG_NDVI", "LOG_EVI", "GAM_NDVI", "GAM_EVI", "PEP_SOS","TT","SQ")], 2, 
  ...
  "r2_east_west" = apply(GDD_SOS[c("LOG_NDVI", "LOG_EVI", "GAM_NDVI", "GAM_EVI", "PEP_SOS","TT","SQ")], 2, 
  ...
  "r2_urban" = apply(GDD_SOS[c("LOG_NDVI", "LOG_EVI", "GAM_NDVI", "GAM_EVI", "PEP_SOS","TT","SQ")], 2, 
